package com.example.layoutoptimization;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((((int) (Math.random() * 100)) & 0x01) == 0) {
            ...
            ImageView image02 = (ImageView) findViewById(R.id.viewstub_demo_imageview02);
            assert image02 != null;
            image02.setImageResource(R.drawable.ic_02);
        }
    }
